...
const Project = () => {
  return (
    <div className='flex h-full flex-col items-center justify-center rounded-lg bg-gray-800 p-4 shadow-md'>
      <a
        href='https://github.com/tyleroneil72/nest'
        target='_blank'
        rel='noopener noreferrer'
        className='flex w-full justify-center'
      >
        <img
          src='https://github-readme-stats.vercel.app/api/pin/?username=tyleroneil72&repo=nest&theme=material-palenight&title_color=FFF'
